# ER Medical Triage AI - Système Intelligent de Gestion des Urgences

**Français** | [English](./README.md)

## Présentation

L'ER Medical Triage AI est un système avancé de gestion des soins de santé conçu pour optimiser les flux de travail des services d'urgence grâce à l'intelligence artificielle et à la surveillance des patients en temps réel. Cette plateforme complète intègre l'enregistrement vocal des patients, l'analyse de triage alimentée par l'IA et la gestion intelligente des flux de travail pour améliorer l'efficacité de la prestation des soins de santé et les résultats pour les patients.
