# ER Medical Triage AI - Intelligent Emergency Department Management System

[Français](./README_FR.md) | **English**

## Overview

The ER Medical Triage AI is an advanced healthcare management system designed to optimize emergency department workflows through artificial intelligence and real-time patient monitoring. This comprehensive platform integrates voice-enabled patient check-in, AI-powered triage analysis, and intelligent workflow management to enhance healthcare delivery efficiency and patient outcomes.
